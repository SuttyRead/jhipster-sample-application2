<template>
  <div>
    <h2 id="page-heading" data-cy="DepartmentHeading">
      <span v-text="t$('jhipsterSampleApplication2App.department.home.title')" id="department-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jhipsterSampleApplication2App.department.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'DepartmentCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('jhipsterSampleApplication2App.department.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && departments && departments.length === 0">
      <span v-text="t$('jhipsterSampleApplication2App.department.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="departments">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('jhipsterSampleApplication2App.department.departmentName')"></span></th>
            <th scope="row"><span v-text="t$('jhipsterSampleApplication2App.department.location')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="jhipsterSampleApplication2App.department.delete.question"
          data-cy="departmentDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-department-heading" v-text="t$('jhipsterSampleApplication2App.department.delete.question', { id: removeId })"></p>
      </div>
