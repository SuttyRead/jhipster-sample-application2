  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplication2App.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="t$('jhipsterSampleApplication2App.employee.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleApplication2App.employee.firstName')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.employee.lastName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplication2App.employee.email')" for="employee-email"></label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.employee.phoneNumber')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.employee.hireDate')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplication2App.employee.salary')" for="employee-salary"></label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.employee.commissionPct')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplication2App.employee.manager')" for="employee-manager"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.employee.department')"
