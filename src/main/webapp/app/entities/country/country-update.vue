  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplication2App.country.home.createOrEditLabel"
          data-cy="CountryCreateUpdateHeading"
          v-text="t$('jhipsterSampleApplication2App.country.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleApplication2App.country.countryName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplication2App.country.region')" for="country-region"></label>
