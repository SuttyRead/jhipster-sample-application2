  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplication2App.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('jhipsterSampleApplication2App.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleApplication2App.jobHistory.startDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.jobHistory.endDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.jobHistory.language')"
            ...
            >
              <option
                ...
                v-bind:label="t$('jhipsterSampleApplication2App.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplication2App.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.jobHistory.department')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplication2App.jobHistory.employee')"
