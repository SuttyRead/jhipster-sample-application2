    ...
    <div class="col-8">
      <div v-if="jobHistory">
        <h2 class="jh-entity-heading" data-cy="jobHistoryDetailsHeading">
          <span v-text="t$('jhipsterSampleApplication2App.jobHistory.detail.title')"></span> {{ jobHistory.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-text="t$('jhipsterSampleApplication2App.Language.' + jobHistory.language)"></span>
          </dd>
          <dt>
